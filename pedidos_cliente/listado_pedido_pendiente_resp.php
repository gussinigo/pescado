		            ...
		            <div class="row">
			            <div class="card card-transparent">
						  	<div class="card-header col-5">
						    	<div class="card-title">PEDIDOS PENDIENTES DE ACTUALIZAR PESO</div>
						    </div>
						    ...
						    <table class="table table-hover demo-table-search table-responsive-block" id="tableWithSearch">
								...
								<tbody>
							        <tr>
										...
										<td class="v-align-middle">
											<a href="pedidos_cliente_detalle.php">
											<button aria-label="" class="btn btn-complete" onclick="">Actualizar <i class="pg-icon">pencil</i></button>
											</a>
										</td>
										<td class="v-align-middle">
