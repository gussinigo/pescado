<?php 
	...
	$sql = "select p.*, pr.proveedor from productos p, proveedores pr where p.idproveedor = pr.idproveedor ";
	    ...
	    function fnEliminar(id){
		    try{
			    ...
			    if(confirm('¿Desea eliminar el registro?')){
			        ...
			        jQuery.post("acciones_productos.php?mode=delete", {
							hdnid:id
			...
			<div class=" container-fluid   container-fixed-lg bg-white">
				...
				<div class="card card-transparent">
				  	<div class="card-header ">
				    	<div class="card-title">Listado de Productos
				    </div>
						...
						<tbody>
					        ...
					        <tr>
								<td class="v-align-middle">
									<p><?php echo utf8_encode($row['codigo']); ?></p>
								</td>
								<td class="v-align-middle">
									<p><?php echo utf8_encode($row['producto']); ?></p>
								</td>
								<td class="v-align-middle">
									<p><?php echo utf8_encode($row['proveedor']); ?></p>
								</td>
								<td class="v-align-middle">
									<p><?php echo utf8_encode($row['costo_compra']); ?></p>
								</td>
								<td class="v-align-middle">
									<p><?php echo utf8_encode($row['costo_venta']); ?></p>
								</td>
								<td class="v-align-middle">
									<button aria-label="" class="btn btn-danger" onclick="fnEliminar('<?php echo $row['idproducto']; ?>');">Borrar</button>
								</td>
								<td class="v-align-middle">
									<button aria-label="" class="btn btn-complete" onclick="fnEditar('<?php echo $row['idproducto']; ?>');">Editar</button>
								</td>
							</tr>
							<?php 
								}
