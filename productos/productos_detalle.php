<?php 
	...
	if($id == ''){
		$action = "acciones_productos.php?mode=insert";
	} else {
		$action = "acciones_productos.php?mode=edit";
    ...
    <script>
	    ...
	    function fnGuardar(){
		    try
		    {
			    if(fnValida()){
				    ...
				    var txtcostocompra = $('#txtcostocompra').val();
				    var txtcostoventa = $('#txtcostoventa').val();
				    ...
				    $.blockUI({ 
				     ...
				     jQuery.post("<?php echo $action; ?>", {
								...
								txtcodigo:txtcodigo,
								txtcostocompra:txtcostocompra,
								txtcostoventa:txtcostoventa,
	    ...
	    function fnValida(){
		    ...
		    try
		    {
			    ...
			    if(txtproducto == '') return false;
			    if(txtcodigo == '') return false;
			    if(txtcostocompra == '') return false;
			    if(txtcostoventa == '') return false;
			    if(idproveedor == '') return false;
					...
					<div class="row">
		            	<div class="col-xl-6 col-lg-6 ">
							<div class="card card-transparent">
				                ...
				                <div class="card-body">
				                    <h3>Este es nuestro registro basico de un producto
										aqui pondremos uno de los productos de el proveedor.</h3>
				                    <p>La lista de proveedores para elegir sera recibida de los
				                      <br> proveedores que estan registrados. <br>
				                </div>
		                	</div>
		              	</div>
						<div class="col-xl-6 col-lg-6 ">
				                ...
				                <div class="card">
									...
									<div class="card-body">
										<input type="hidden" id="hdnid" name="hdnid" value="<?php echo $id; ?>" />
											...
											<h3 class="mw-80">Productos</h3>
											
										    <div class="form-group-attached">
											    <div class="form-group form-group-default required">
										    	<label>Proveedor</label>
							                        <select class="full-width" data-init-plugin="select2" id="idproveedor" name="idproveedor">
								                        <option value="">Seleccione una opcion</option>
							                        	<optgroup label="proveedor">
							                        	<?php
								                        	$qr="select * from proveedores";
								                        	$res_qr = mysqli_query($link, $qr);
								                        	while ($row_qr = mysqli_fetch_array($res_qr)){
									                        	if($row_qr['idproveedor'] == $row['idproveedor']){
										                        	$selected = "selected='selected'";
									                        	} else {
										                        	$selected = '';
									                        	}
							                        	?>
															<option value="<?php echo $row_qr['idproveedor']; ?>" <?php echo $selected; ?>><?php echo utf8_encode($row_qr['proveedor']); ?></option>
														<?php 
															}
														?>
							                        	</optgroup>
										    ...
										    <div class="form-group-attached">
										    	<div class="form-group form-group-default required">
													...
													<input type="text" class="form-control" id="txtproducto" name="txtproducto" placeholder="Nombre del Producto" value="<?php echo utf8_encode($row['producto']); ?>" required>
										    	</div>
										    </div>
										    <div class="form-group-attached">
										    	<div class="form-group form-group-default required">
													<label>Codigo</label>
													<input type="text" class="form-control" id="txtcodigo" name="txtcodigo" placeholder="Codigo del Producto" value="<?php echo utf8_encode($row['codigo']); ?>" required>
										    	</div>
										    </div>
										    <div class="form-group-attached">
													...
													<div class="col-md-6">
														<div class="form-group form-group-default required">
															<div class="form-group ">
																...
																<input type="text" class="form-control" id="txtcostocompra" name="txtcostocompra" placeholder="Costo de Compra" value="<?php echo utf8_encode($row['costo_compra']); ?>" required>
								                      		</div>
										        		</div>
										        	</div>
										        	<div class="col-md-6">
														<div class="form-group form-group-default required">
															<div class="form-group ">
																...
																<input type="text" class="form-control" id="txtcostoventa" name="txtcostoventa" placeholder="Costo de Venta" value="<?php echo utf8_encode($row['costo_venta']); ?>" required>
								                      		</div>
										        		</div>
										        	</div>
										        </div>
