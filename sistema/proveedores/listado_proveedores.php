...
<html lang="en">
  <head>
    ...
    <script>
		...
		function fnReporte(id){
			window.location.href = 'reporte_proveedor.php?id=' + id;
			
		}
	    
	    function fnEditar(id){
		    window.location.href = 'proveedores_detalle.php?id=' + id;
	    ...
	    function fnEliminar(id){
		    try{
			    ...
			    if(confirm('¿Desea eliminar el registro?')){
			        ...
			        jQuery.post("acciones_proveedores.php?mode=delete", {
							hdnid:id
			...
			<div class=" container-fluid   container-fixed-lg bg-white">
				...
				<div class="card card-transparent">
				  	<div class="card-header ">
				    	<div class="card-title">Listado de Proveedores
				    </div>
				    ...
				    <table class="table table-hover demo-table-search table-responsive-block" id="tableWithSearch">
						...
						<tbody>
					        ...
					        <tr>
								...
								<td class="v-align-middle">
									<p><?php echo utf8_encode($row['telefono']); ?></p>
								</td>
								<td class="v-align-middle">
									<button aria-label="" class="btn btn-danger" onclick="fnEliminar('<?php echo $row['idproveedor']; ?>');">Borrar</button>
								</td>
								<td class="v-align-middle">
									<button aria-label="" class="btn btn-complete" onclick="fnEditar('<?php echo $row['idproveedor']; ?>');" >Editar</button>
								</td>
								<td class="v-align-middle">
									<!--<a href="invoice.php">-->
									<button aria-label="" class="btn btn-default" onclick="fnReporte('<?php echo $row['idproveedor']; ?>');">Reporte<i class="pg-icon">printer</i></button>
									<!--</a>-->
								</td>
							</tr>
							<?php 
