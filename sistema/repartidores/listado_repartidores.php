<?php 
	...
	$sql = "select r.*, z.zona from repartidores r, zonas z where r.idzona = z.idzona ";
  ...
  <head>
    ...
    <script>
	    ...
	    function fnEditar(id){
		    window.location.href = 'repartidores_detalle.php?id=' + id;
	    ...
	    function fnEliminar(id){
		    try{
			    ...
			    if(confirm('¿Desea eliminar el registro?')){
			        ...
			        jQuery.post("acciones_repartidores.php?mode=delete&sec=1", {
							hdnid:id
			...
			<div class=" container-fluid   container-fixed-lg bg-white">
				...
				<div class="card card-transparent">
				  	<div class="card-header ">
				    	<div class="card-title">Listado de Repartidores
				    </div>
						...
						<tbody>
					        ...
					        <tr>
								<td class="v-align-middle">
									<p><?php echo utf8_encode($row['repartidor']); ?></p>
								</td>
								<td class="v-align-middle">
								...
								<td class="v-align-middle">
									<button aria-label="" class="btn btn-danger" onclick="fnEliminar('<?php echo $row['idrepartidor']; ?>');">Borrar</button>
								</td>
								<td class="v-align-middle">
									<button aria-label="" class="btn btn-complete" onclick="fnEditar('<?php echo $row['idrepartidor']; ?>');">Editar</button>
								</td>
							</tr>
							<?php 
								}
